...
internal enum Asset {
  internal enum AssetsIOS {
    ...
    internal static let iconFacebook = ImageAsset(name: "icon_facebook")
  ...
  internal enum ColorsIOS {
    internal static let commonDark = ColorAsset(name: "common_dark")
    internal static let commonWhite = ColorAsset(name: "common_white")
    internal static let grayBorder = ColorAsset(name: "gray_border")
  }
}
